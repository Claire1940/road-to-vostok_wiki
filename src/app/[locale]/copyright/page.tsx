...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Road to Vostok Wiki',
    description: 'Copyright and intellectual property information for Road to Vostok Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    keywords: [
      'copyright notice',
      'Road to Vostok Wiki copyright',
      'DMCA policy',
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Road to Vostok Wiki',
      description: 'Copyright and intellectual property information for Road to Vostok Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Road to Vostok Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Road to Vostok Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Road to Vostok Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Steam</strong> - Owner of the Steam platform</li>
              <li><strong>Road to Vostok Developers</strong> - Creators of the Road to Vostok game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>Road to Vostok</strong> - Trademark of the game developers</li>
              <li><strong>Road to Vostok Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Road to Vostok Wiki.
            </p>
            ...
            <p>
              ...
              Road to Vostok Wiki<br />
              Email: <a href="mailto:dmca@road-to-vostok.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@road-to-vostok.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Road to Vostok Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Road to Vostok Wiki (road-to-vostok.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@road-to-vostok.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@road-to-vostok.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@road-to-vostok.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@road-to-vostok.wiki</a>
            </p>
            <p>
