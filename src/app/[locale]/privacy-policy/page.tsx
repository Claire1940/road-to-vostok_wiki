...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Privacy Policy - Road to Vostok Wiki',
    description: 'Road to Vostok Wiki Privacy Policy. Learn how we collect, use, and protect your data when you use our Steam Early Access game resource platform. Your privacy matters to us.',
    keywords: [
      'privacy policy',
      'Road to Vostok Wiki privacy',
      'data protection',
      'user privacy',
      'GDPR compliance',
    ],
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Road to Vostok Wiki ("we", "our", or "us") collects minimal information to provide and improve our services.
            ...
            <h2>11. Disclaimer</h2>
            <p>
              Road to Vostok Wiki is an unofficial fan-made website and is not affiliated with, endorsed by, or associated
              with Valve Corporation (Steam) or the developers of Road to Vostok. All game content, trademarks, and assets are
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:privacy@road-to-vostok.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">privacy@road-to-vostok.wiki</a>
            </p>
            <p>
