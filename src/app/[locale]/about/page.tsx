...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'About Road to Vostok Wiki - Your Ultimate Steam Game Resource',
    description: 'Learn about Road to Vostok Wiki, a community-driven resource hub providing comprehensive guides, crafting tips, creature info, and strategies for the Road to Vostok Steam Early Access game.',
    keywords: [
      'about Road to Vostok Wiki',
      'Road to Vostok community',
      'Steam Early Access game wiki',
      'game resource hub',
      'Road to Vostok team',
    ],
    robots: {
    ...
    openGraph: {
      ...
      title: 'About Road to Vostok Wiki',
      description: 'Learn about our mission to provide the best Road to Vostok game resources and guides.',
      images: [
        {
    ...
    twitter: {
      ...
      title: 'About Road to Vostok Wiki',
      description: 'Learn about our mission to provide the best Road to Vostok game resources.',
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Your community-driven resource center for Road to Vostok
          </p>
        </div>
      </section>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            <h2>Welcome to Road to Vostok Wiki</h2>
            <p>
              Road to Vostok Wiki is an <strong>unofficial, fan-made resource website</strong> dedicated to helping players
              master the Steam Early Access game "Road to Vostok". We are a community-driven platform that provides comprehensive guides,
            ...
            <p>
              ...
              Road to Vostok Wiki is here to support you every step of the way.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 px-4 bg-slate-900/30">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            <h2>Our Mission</h2>
            <p>
              Our mission is simple: <strong>to empower Road to Vostok players with accurate, up-to-date information
            ...
            <h2>Our Vision</h2>
            <p>
              We envision Road to Vostok Wiki as the <strong>go-to destination</strong> for every Road to Vostok player seeking
      ...
      <section className="py-12 px-4 bg-slate-900/30">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Road to Vostok Wiki is built <strong>by the community, for the community</strong>. We welcome contributions,
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Road to Vostok Wiki is maintained by a dedicated team of passionate gamers and developers who love
              Road to Vostok as much as you do. We're players first, constantly testing strategies, exploring game
            ...
            <ul>
              <li><strong>Game analysis:</strong> Deep understanding of Road to Vostok mechanics and strategies</li>
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p className="text-yellow-400/90">
              <strong>Road to Vostok Wiki is an unofficial fan-made website.</strong> We are NOT affiliated with,
              endorsed by, or associated with the developers of Road to Vostok or any official entities.
            </p>
            <p>
            ...
            <p>
              Road to Vostok Wiki is a non-profit, community resource created by fans, for fans.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <div className="not-prose grid md:grid-cols-2 gap-4 my-6">
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                ...
                <a href="mailto:contact@road-to-vostok.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  contact@road-to-vostok.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Bug Reports</h3>
                <a href="mailto:support@road-to-vostok.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  support@road-to-vostok.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Content Submissions</h3>
                <a href="mailto:contribute@road-to-vostok.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  contribute@road-to-vostok.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Partnerships</h3>
                <a href="mailto:partnerships@road-to-vostok.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  partnerships@road-to-vostok.wiki
                </a>
              </div>
            </div>
      ...
      <section className="py-12 px-4 bg-gradient-to-r from-purple-900/30 to-blue-900/30 border-y border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 mb-6 max-w-2xl mx-auto">
            Stay updated with the latest guides, tips, and Road to Vostok news.
